...
void LRRHW<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
LRRHW<BasicTurbulenceModel>::LRRHW
(
...
template<class BasicTurbulenceModel>
bool LRRHW<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volSymmTensorField> LRRHW<BasicTurbulenceModel>::DREff() const
{
...
template<class BasicTurbulenceModel>
tmp<volSymmTensorField> LRRHW<BasicTurbulenceModel>::DepsilonEff() const
{
    return tmp<volSymmTensorField>
    (
        new volSymmTensorField
...
template<class BasicTurbulenceModel>
void LRRHW<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
