...
void dynamicSmagorinskyDev<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
dynamicSmagorinskyDev<BasicTurbulenceModel>::dynamicSmagorinskyDev
(
...
template<class BasicTurbulenceModel>
bool dynamicSmagorinskyDev<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> dynamicSmagorinskyDev<BasicTurbulenceModel>::epsilon() const
{
...
template<class BasicTurbulenceModel>
void dynamicSmagorinskyDev<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
