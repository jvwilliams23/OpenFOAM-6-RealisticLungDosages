...
makeLESModel(dynamicKEqnDev);

#include "dynamicSmagorinsky.H"
makeLESModel(dynamicSmagorinsky);

#include "dynamicSmagorinskyWDynamicCeps.H"
makeLESModel(dynamicSmagorinskyWDynamicCeps);

#include "dynamicSmagorinskyDev.H"
makeLESModel(dynamicSmagorinskyDev);

#include "standardSmagorinsky.H"
makeLESModel(standardSmagorinsky);

#include "SmagorinskyWithTurbProps.H"
makeLESModel(SmagorinskyWithTurbProps);

#include "dynamicLagrangianDev.H"
makeLESModel(dynamicLagrangianDev);
