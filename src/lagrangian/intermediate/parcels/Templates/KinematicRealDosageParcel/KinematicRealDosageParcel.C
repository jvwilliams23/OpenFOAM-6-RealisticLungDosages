...
Foam::label Foam::KinematicRealDosageParcel<ParcelType>::maxTrackAttempts = 1;
...
void Foam::KinematicRealDosageParcel<ParcelType>::setCellValues
(
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::KinematicRealDosageParcel<ParcelType>::calcDispersion
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::KinematicRealDosageParcel<ParcelType>::cellValueSourceCorrection
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::KinematicRealDosageParcel<ParcelType>::calc
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
const Foam::vector Foam::KinematicRealDosageParcel<ParcelType>::calcVelocity
(
    TrackCloudType& cloud,
    trackingData& td,
    const scalar dt,
...
template<class ParcelType>
Foam::KinematicRealDosageParcel<ParcelType>::KinematicRealDosageParcel
(
    const KinematicRealDosageParcel<ParcelType>& p
)
:
    ParcelType(p),
    active_(p.active_),
...
template<class ParcelType>
template<class TrackCloudType>
bool Foam::KinematicRealDosageParcel<ParcelType>::move
(
    TrackCloudType& cloud,
    trackingData& td,
...
template<class ParcelType>
template<class TrackCloudType>
bool Foam::KinematicRealDosageParcel<ParcelType>::hitPatch
(
    TrackCloudType& cloud,
    trackingData& td
)
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::KinematicRealDosageParcel<ParcelType>::hitProcessorPatch
(
    TrackCloudType&,
    trackingData& td
)
...
template<class ParcelType>
template<class TrackCloudType>
void Foam::KinematicRealDosageParcel<ParcelType>::hitWallPatch
(
    TrackCloudType&,
    trackingData&
)
...
template<class ParcelType>
void Foam::KinematicRealDosageParcel<ParcelType>::transformProperties(const tensor& T)
{
...
template<class ParcelType>
void Foam::KinematicRealDosageParcel<ParcelType>::transformProperties
(
...
#include "KinematicRealDosageParcelIO.C"
