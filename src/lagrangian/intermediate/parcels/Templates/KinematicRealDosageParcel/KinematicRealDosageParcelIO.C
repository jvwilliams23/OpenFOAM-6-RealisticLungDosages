...
Foam::string Foam::KinematicRealDosageParcel<ParcelType>::propertyList_ =
    Foam::KinematicRealDosageParcel<ParcelType>::propertyList();

template<class ParcelType>
const std::size_t Foam::KinematicRealDosageParcel<ParcelType>::sizeofFields_
(
    sizeof(KinematicRealDosageParcel<ParcelType>)
  - offsetof(KinematicRealDosageParcel<ParcelType>, active_)
);
    ...
    UTurb_(Zero)
{
    ...
    is.check
    (
        "KinematicRealDosageParcel<ParcelType>::KinematicRealDosageParcel"
...
void Foam::KinematicRealDosageParcel<ParcelType>::readFields(CloudType& c)
{
    bool valid = c.size();
    ...
    {
        KinematicRealDosageParcel<ParcelType>& p = iter();
...
template<class ParcelType>
template<class CloudType>
void Foam::KinematicRealDosageParcel<ParcelType>::writeFields(const CloudType& c)
{
    ...
    {
        const KinematicRealDosageParcel<ParcelType>& p = iter();
...
)
{
    ...
    else
    {
        ...
        (
            ...
            KinematicRealDosageParcel<ParcelType>::sizeofFields_
        );
    }
    ...
    os.check
    (
        "Ostream& operator<<(Ostream&, const KinematicRealDosageParcel<ParcelType>&)"
    );
