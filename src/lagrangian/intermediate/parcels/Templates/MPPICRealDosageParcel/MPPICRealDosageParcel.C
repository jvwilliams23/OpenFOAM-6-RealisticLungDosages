...
void Foam::MPPICRealDosageParcel<ParcelType>::updateCharge
(
...
void Foam::MPPICRealDosageParcel<ParcelType>::setCellValues
(
    TrackData& td,
    const scalar dt,
    const label cellI
...
template<class ParcelType>
template<class TrackCloudType>
bool Foam::MPPICRealDosageParcel<ParcelType>::move
(
	TrackCloudType& cloud,
    trackingData& td,
    const scalar trackTime
...
#include "MPPICRealDosageParcelIO.C"
