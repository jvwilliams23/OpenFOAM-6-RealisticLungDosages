...
#include "KinematicRealDosageCloud.H"
...
void Foam::KinematicRealDosageCloud<CloudType>::setModels()
{
    dispersionModel_.reset
    (
        DispersionModel<KinematicRealDosageCloud<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        PatchInteractionModel<KinematicRealDosageCloud<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        StochasticCollisionModel<KinematicRealDosageCloud<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        SurfaceFilmModel<KinematicRealDosageCloud<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
...
void Foam::KinematicRealDosageCloud<CloudType>::solve
(
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::buildCellOccupancy()
{
    ...
    forAllIter(typename KinematicRealDosageCloud<CloudType>, *this, iter)
    {
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::updateCellOccupancy()
{
...
template<class CloudType>
template<class TrackCloudType>
void Foam::KinematicRealDosageCloud<CloudType>::evolveCloud
(
    TrackCloudType& cloud,
    typename parcelType::trackingData& td
)
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::postEvolve()
{
    Info<< endl;
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::cloudReset(KinematicRealDosageCloud<CloudType>& c)
{
...
template<class CloudType>
Foam::KinematicRealDosageCloud<CloudType>::KinematicRealDosageCloud
(
...
Foam::KinematicRealDosageCloud<CloudType>::KinematicRealDosageCloud
(
    KinematicRealDosageCloud<CloudType>& c,
    const word& name
)
:
...
(
    const fvMesh& mesh,
    const word& name,
    const KinematicRealDosageCloud<CloudType>& c
)
:
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::setParcelThermoProperties
(
    parcelType& parcel,
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::checkParcelProperties
(
    parcelType& parcel,
    const scalar lagrangianDt,
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::storeState()
{
    cloudCopyPtr_.reset
    (
        static_cast<KinematicRealDosageCloud<CloudType>*>
        (
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::restoreState()
{
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::resetSourceTerms()
{
    UTrans().field() = Zero;
    UCoeff().field() = 0.0;
}
...
template<class CloudType>
template<class Type>
void Foam::KinematicRealDosageCloud<CloudType>::relax
(
...
template<class CloudType>
template<class Type>
void Foam::KinematicRealDosageCloud<CloudType>::scale
(
    DimensionedField<Type, volMesh>& field,
    const word& name
) const
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::relaxSources
(
    const KinematicRealDosageCloud<CloudType>& cloudOldTime
)
{
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::scaleSources()
{
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::preEvolve()
{
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::evolve()
{
...
template<class CloudType>
template<class TrackCloudType>
void Foam::KinematicRealDosageCloud<CloudType>::motion
(
    TrackCloudType& cloud,
    typename parcelType::trackingData& td
)
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::patchData
(
    const parcelType& p,
    const polyPatch& pp,
    vector& nw,
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::updateMesh()
{
    updateCellOccupancy();
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::autoMap(const mapPolyMesh& mapper)
{
...
template<class CloudType>
void Foam::KinematicRealDosageCloud<CloudType>::info()
{
