...
#include "CollidingRealDosageCloud.H"
...
void Foam::CollidingRealDosageCloud<CloudType>::setModels()
{
    collisionModel_.reset
    (
        CollisionModel<CollidingRealDosageCloud<CloudType>>::New
        (
...
void Foam::CollidingRealDosageCloud<CloudType>::moveCollide
(
...
template<class CloudType>
void Foam::CollidingRealDosageCloud<CloudType>::cloudReset(CollidingRealDosageCloud<CloudType>& c)
{
...
template<class CloudType>
Foam::CollidingRealDosageCloud<CloudType>::CollidingRealDosageCloud
(
    ...
    collisionModel_(nullptr)
{
    if (this->solution().active())
    {
        ...
        (
         ...
         && !isType<NoCollision<CollidingRealDosageCloud<CloudType>>>(collisionModel_())
        )
        {
...
template<class CloudType>
void Foam::CollidingRealDosageCloud<CloudType>::storeState()
{
    cloudCopyPtr_.reset
    (
        static_cast<CollidingRealDosageCloud<CloudType>*>
        (
...
template<class CloudType>
void Foam::CollidingRealDosageCloud<CloudType>::restoreState()
{
...
template<class CloudType>
void Foam::CollidingRealDosageCloud<CloudType>::evolve()
{
...
template<class CloudType>
template<class TrackCloudType>
void  Foam::CollidingRealDosageCloud<CloudType>::motion
(
    TrackCloudType& cloud,
    typename parcelType::trackingData& td
)
...
template<class CloudType>
void Foam::CollidingRealDosageCloud<CloudType>::info()
{
    CloudType::info();
