...
#include "MPPICRealDosageCloud.H"
...
void Foam::MPPICRealDosageCloud<CloudType>::setModels()
{
    packingModel_.reset
    (
        PackingModel<MPPICRealDosageCloud<CloudType> >::New
        (
    ...
    dampingModel_.reset
    (
        DampingModel<MPPICRealDosageCloud<CloudType> >::New
        (
            this->subModelProperties(),
            *this
        ).ptr()
    ...
    (
        IsotropyModel<MPPICRealDosageCloud<CloudType> >::New
        (
            this->subModelProperties(),
            *this
        ).ptr()
...
template<class CloudType>
Foam::MPPICRealDosageCloud<CloudType>::MPPICRealDosageCloud
(
...
template<class CloudType>
void Foam::MPPICRealDosageCloud<CloudType>::storeState()
{
    cloudCopyPtr_.reset
    (
        static_cast<MPPICRealDosageCloud<CloudType>*>
        (
...
template<class CloudType>
void Foam::MPPICRealDosageCloud<CloudType>::restoreState()
{
...
template<class CloudType>
void Foam::MPPICRealDosageCloud<CloudType>::evolve()
{
...
void Foam::MPPICRealDosageCloud<CloudType>::setChargeCellValues(TrackData& td)
{
...
template<class CloudType>
template<class TrackData>
void Foam::MPPICRealDosageCloud<CloudType>::updateParcelCharge(TrackData& td)
{
...
void Foam::MPPICRealDosageCloud<CloudType>::motion
(
...
template<class CloudType>
void Foam::MPPICRealDosageCloud<CloudType>::info()
{
    CloudType::info();
    ...
    forAll(this->mesh().cells(), cellI)
    {
        ...
        if (n > 0)
        {
            const scalar nPack = n*alphaMax/(alpha()[cellI] + SMALL);
